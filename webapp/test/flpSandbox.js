		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat App",
									"targetURL": "#zacofuadchatapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zacofuadchatapp-display": {
								"semanticObject": "zacofuadchatapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=za.co.fuad.chatapp",
									"url": sap.ui.require.toUrl("za/co/fuad/chatapp")
								}
							}
						}
					}
